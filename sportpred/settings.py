...
SECRET_KEY = 'django-insecure-antigravity-predictions-dev-key-change-in-production'
...
SIMPLE_JWT = {
    ...
    'ALGORITHM': 'HS256',
    'SIGNING_KEY': os.environ.get('JWT_SECRET', 'super-secret-jwt-key-change-in-production'),
    'VERIFYING_KEY': None,
